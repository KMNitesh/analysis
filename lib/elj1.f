...
c
      ...
      integer, allocatable :: iv14(:)
      real*8 e,de,p6,p12,eps
      real*8 tau,tau2,tau3
      real*8 dtau,dtau2,dtau3
      real*8 rv,rdn,fgrp
      real*8 xi,yi,zi
      real*8 xr,yr,zr
      real*8 redi,rediv
...
!$OMP& i12,i13,i14,i15,v2scale,v3scale,v4scale,v5scale,vlambda,
!$OMP& use_group,off2,radmin,epsilon,radmin4,epsilon4,mut,
...
c
     ...
     &                (mutk .and. .not.muti)) then
                      ...
                      dtau2 = dtau *dtau
                      dtau3 = dtau*dtau2
                      e = 8*vlambda * eps * (2.0d0*dtau2-dtau)
                      de = 192*vlambda * eps * (1/p6) *
     &                         (1/rik)*(dtau2-4.0d0*dtau3)
