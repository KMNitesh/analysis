...
public:
    ...
    using argument_type = std::tuple<boost::multi_array<ATOM_Category, 3> *,
...
protected:
    ...
    void fill_atom(boost::multi_array<ATOM_Category, 3> *grid,
    ...
    bool fill_space(boost::multi_array<ATOM_Category, 3> *grid,
    ...
    do_grid(boost::multi_array<ATOM_Category, 3> *grid, boost::multi_array<double, 2> *atom_group_array,
