...
class Histogram2D {
public:
    Histogram2D(const std::pair<double, double> &range1, double width1, const std::pair<double, double> &range2,
                double width2);
    ...
    void initialize(const std::pair<double, double> &range1, double width1, const std::pair<double, double> &range2,
                    double width2);
