...
template <typename Iterator, typename Skipper> struct Grammar : qi::grammar<Iterator, Atom::Node(), Skipper> {
  ...
  inline static auto protein = Atom::select_ranges{"ABU", "ACE", "AIB", "ALA", "ARG", "ARGN", "ASN", "ASN1", "ASP",
      "ASP1", "ASPH", "ASPP", "ASH", "CT3", "CYS", "CYS1", "CYS2", "CYSH", "DALA", "GLN", "GLU", "GLUH", "GLUP", "GLH",
      "GLY", "HIS", "HIS1", "HISA", "HISB", "HISH", "HISD", "HISE", "HISP", "HSD", "HSE", "HSP", "HYP", "ILE", "LEU",
      "LSN", "LYS", "LYSH", "MELEU", "MET", "MEVAL", "NAC", "NME", "NHE", "NH2", "PHE", "PHEH", "PHEU", "PHL", "PRO",
      "SER", "THR", "TRP", "TRPH", "TRPU", "TYR", "TYRH", "TYRU", "VAL", "PGLU", "HID", "HIE", "HIP", "LYP", "LYN",
      "CYN", "CYM", "CYX", "DAB", "ORN", "NALA", "NGLY", "NSER", "NTHR", "NLEU", "NILE", "NVAL", "NASN", "NGLN", "NARG",
      "NHID", "NHIE", "NHIP", "NHISD", "NHISE", "NHISH", "NTRP", "NPHE", "NTYR", "NGLU", "NASP", "NLYS", "NORN", "NDAB",
      "NLYSN", "NPRO", "NHYP", "NCYS", "NCYS2", "NMET", "NASPH", "NGLUH", "CALA", "CGLY", "CSER", "CTHR", "CLEU",
      "CILE", "CVAL", "CASN", "CGLN", "CARG", "CHID", "CHIE", "CHIP", "CHISD", "CHISE", "CHISH", "CTRP", "CPHE", "CTYR",
      "CGLU", "CASP", "CLYS", "CORN", "CDAB", "CLYSN", "CPRO", "CHYP", "CCYS", "CCYS2", "CMET", "CASPH", "CGLUH"};

  inline static auto dna = Atom::select_ranges{
      "DA5", "DA", "DA3", "DAN", "DT5", "DT", "DT3", "DTN", "DG5", "DG", "DG3", "DGN", "DC5", "DC", "DC3", "DCN"};

  inline static auto rna = Atom::select_ranges{"A", "U", "C", "G", "RA5", "RA", "RA3", "RAN", "RU5", "RU", "RU3", "RUN",
...
#define DISTINCT(x) distinct(char_("a-zA-Z_0-9") | char_("-+"))[x]
  ...
  macro_rule =
      ...
      | DISTINCT("Protein-H")[_val = make_shared_<Atom::Operator>(Atom::Op::AND,
      ...
      DISTINCT(
          "Backbone")[_val = make_shared_<Atom::Operator>(Atom::Op::AND, make_shared_<Atom::residue_name_nums>(protein),
                          make_shared_<Atom::atom_name_nums>(Atom::select_ranges{"CA", "C", "N"}))]

      | DISTINCT("MainChain")[_val = make_shared_<Atom::Operator>(Atom::Op::AND,
                                  make_shared_<Atom::residue_name_nums>(protein),
                                  make_shared_<Atom::atom_name_nums>(Atom::select_ranges{"CA", "C", "N", "O"}))]

      |
      DISTINCT("MainChain+Cb")[_val = make_shared_<Atom::Operator>(Atom::Op::AND,
                                   make_shared_<Atom::residue_name_nums>(protein),
                                   make_shared_<Atom::atom_name_nums>(Atom::select_ranges{"CA", "C", "N", "O", "CB"}))]

      | DISTINCT("MainChain+H")[_val = make_shared_<Atom::Operator>(Atom::Op::AND,
                                    make_shared_<Atom::residue_name_nums>(protein),
                                    make_shared_<Atom::atom_name_nums>(Atom::select_ranges{"CA", "C", "N", "O", "H"}))]

      |
      DISTINCT(
          "C-alpha")[_val = make_shared_<Atom::Operator>(Atom::Op::AND, make_shared_<Atom::residue_name_nums>(protein),
                         make_shared_<Atom::atom_name_nums>(Atom::select_ranges{"CA"}))]

      |
      DISTINCT("SideChain")[_val = make_shared_<Atom::Operator>(Atom::Op::AND,
                                make_shared_<Atom::residue_name_nums>(protein),
      ...
      |
      DISTINCT(
          "SideChain-H")[_val = make_shared_<Atom::Operator>(Atom::Op::AND,
                             make_shared_<Atom::Operator>(Atom::Op::AND, make_shared_<Atom::residue_name_nums>(protein),
                                 make_shared_<Atom::Operator>(
      ...
      | DISTINCT("DNA-H")[_val = make_shared_<Atom::Operator>(Atom::Op::AND, make_shared_<Atom::residue_name_nums>(dna),
                              make_shared_<Atom::Operator>(
                                  Atom::Op::NOT, make_shared_<Atom::atom_name_nums>(Atom::select_ranges{"H*"})))]

      | DISTINCT("RNA")[_val = make_shared_<Atom::residue_name_nums>(rna)]

      | DISTINCT("RNA-H")[_val = make_shared_<Atom::Operator>(Atom::Op::AND, make_shared_<Atom::residue_name_nums>(rna),
                              make_shared_<Atom::Operator>(
                                  Atom::Op::NOT, make_shared_<Atom::atom_name_nums>(Atom::select_ranges{"H*"})))]
