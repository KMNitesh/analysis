...
c          charge transfer term
cccccccccccccccccccccccccccccccccccccccccc
         else if (keyword(1:10) .eq. 'CT-LAMBDA ') then
            string = record(next:120)
            read (string,*,err=20)  ctlambda
cccccccccccccccccccccccccccccccccccccccccc
...
c          charge tranfer term
ccccccccccccccccccccccccccccccccccccccccccccccccc
         write (iout,50)  ctlambda
   50    format (' Free Energy Perturbation :',f15.3,
     &              ' Lambda for ChargeTransfer')
ccccccccccccccccccccccccccccccccccccccccccccccccc
      end if
      return
      end
